                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <input type="text" name="name" class="form-control mb-3" value="<?php echo $input_name; ?>"  placeholder="Enter name"> 
                                <span class="text-danger"><?php echo $nameError ?></span>
                                <input type="integer" name="price" class="form-control mb-3" value="<?php echo $price; ?>" placeholder="Enter Price">
                        ...
                        <div class="card-footer">
                            <button class="btn btn-primary" name="Daily-create-button" type ="submit">Create</button>
                        </div>
                        </form>
                    </div>
                </div>
